...
import Activity from "../../crawlActivities/mouse/DragOver";
import { EnumActivityStatus } from "../../enum";
import { ActivityFactoryFactory, IActivityProps } from "../../types/activity";

export interface IMouseDragOverActivityProps<C = any> extends IActivityProps<C> {
    target: Point, data: Protocol.Input.DragData
}

export default (_factory: ActivityFactoryFactory) =>
    <C = any, GC = any>(props: IMouseDragOverActivityProps<C>, globalContext: GC) => {
