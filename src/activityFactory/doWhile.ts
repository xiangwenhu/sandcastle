...
export interface IDoWhileActivityProps<C = any> extends IActivityProps<C> {
    assert: IAssertActivityProps;
    children: IActivityProps[];
}

export default (factory: ActivityFactoryFactory) => <C = any, GC = any>(props: IDoWhileActivityProps<C>, globalContext?: GC) => {
